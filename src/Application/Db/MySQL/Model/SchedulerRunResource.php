...
/**
 * One scheduled/delayed job run (`scheduler_runs`).
 *
 ...
 * Lease/claim state transitions go through the repository's guarded SQL
 * (claimNextDue / renewLease / reclaimExpiredLeases), not through this DTO.
 */
...
final readonly class SchedulerRunResource
{
